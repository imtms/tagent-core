...
import { readWorkspaceFile, WorkspacePathError } from "@tagent/workspace-local/workspace-path";
import type { HttpArtifactContentPort } from "@tagent/http-fastify/ports";
...
export const httpArtifactContent: HttpArtifactContentPort = Object.freeze({
  ...
  isMarkdown: isMarkdownArtifact,
  isText: isTextArtifact,
  loadSource: loadArtifactSource,
  loadDownload: loadArtifactDownload,
});
