...
const delegatedMethods = [
  ...
  "decideAutonomyApproval", "revokeAutonomyApproval", "executeAutonomyApproval", "reviseWorkflow",
  "updateLearningSettings",
  "setRunLearningPolicy", "recordWorkflowFeedback", "setCommunicationPreference",
