...
| ABI SDK | `@tagent/abi@0.8.29` |
| Typed client SDK | `@tagent/core-client@0.8.29` |
...
| --- | --- | --- |
| Core `0.8.29`, current schema, all required profile summaries/details available | ABI + Core Client `0.8.29` | Supported |
| Core `0.8.29`, current schema | hand-written DTOs or direct Console/Admin calls | Unsupported |
| Core `0.8.29`, required profile partially available/unavailable to the actual service principal | any | Unsupported for that profile until scopes/resource grants are corrected |
...
```text
tagent-abi-0.8.29.tgz
tagent-abi-0.8.29.tgz.sha256
tagent-core-client-0.8.29.tgz
tagent-core-client-0.8.29.tgz.sha256
```
