...
| --- | --- |
| Core | `0.8.32` |
| SQLite | `tagent-core/0.8`, version `3` |
| Capability registry | `GET /api/v1/capability-profiles` |
| Profile versions | all five profiles at `1.0` |
| ABI SDK | `@tagent/abi@0.8.32` |
| Typed client SDK | `@tagent/core-client@0.8.32` |
...
| --- | --- | --- |
| Core `0.8.32`, current schema, all required profile summaries/details available | ABI + Core Client `0.8.32` | Supported |
| Core `0.8.32`, current schema | hand-written DTOs or direct Console/Admin calls | Unsupported |
| Core `0.8.32`, required profile partially available/unavailable to the actual service principal | any | Unsupported for that profile until scopes/resource grants are corrected |
...
```text
tagent-abi-0.8.32.tgz
tagent-abi-0.8.32.tgz.sha256
tagent-core-client-0.8.32.tgz
tagent-core-client-0.8.32.tgz.sha256
```
