...
| ABI SDK | `@tagent/abi@0.8.13` |
| Typed client SDK | `@tagent/core-client@0.8.13` |
...
| --- | --- | --- |
| Core `0.8.13`, current schema, all required profile summaries/details available | ABI + Core Client `0.8.13` | Supported |
| Core `0.8.13`, current schema | hand-written DTOs or direct Console/Admin calls | Unsupported |
| Core `0.8.13`, required profile partially available/unavailable to the actual service principal | any | Unsupported for that profile until scopes/resource grants are corrected |
...
```text
tagent-abi-0.8.13.tgz
tagent-abi-0.8.13.tgz.sha256
tagent-core-client-0.8.13.tgz
tagent-core-client-0.8.13.tgz.sha256
```
