...
- [Persistence and recovery](PERSISTENCE_AND_RECOVERY.md) — SQLite ownership, schema 45, Gateway/trusted/request receipts, Skill revisions, writer fencing, Unit of Work, lifecycle, and restart recovery.
