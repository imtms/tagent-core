...
- [Persistence and recovery](PERSISTENCE_AND_RECOVERY.md) — SQLite ownership, schema 44, Gateway/trusted receipts, Skill revisions, writer fencing, Unit of Work, lifecycle, and restart recovery.
