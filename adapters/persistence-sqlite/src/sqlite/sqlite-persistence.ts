...
export class SqlitePersistence {
  ...
  constructor(store: Store, mutationUnitOfWork: MutationUnitOfWork) {
    ...
    const workflowRepository: WorkflowLearningRepository = Object.freeze({
      ...
      recordWorkflowDistillation: mutate(workflowLearning.recordWorkflowDistillation.bind(workflowLearning)),
      ...
      recordGovernanceReceipt: mutate(workflowLearning.recordGovernanceReceipt.bind(workflowLearning)),
      ...
      setBindingMode: mutate(workflowLearning.setBindingMode.bind(workflowLearning)),
