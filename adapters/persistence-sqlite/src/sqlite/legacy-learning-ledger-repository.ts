...
export class LegacyLearningLedgerRepository implements LearningLedgerRepository {
  ...
  listUnprojectedLearningRows(limit: number): LearningProjectionLedgerRow[] {
    return this.db.prepare(`SELECT o.run_id as runId,o.attempt,o.lifecycle,o.outcome,o.event_seq as eventSeq,o.snapshot_json as snapshotJson
      ...
      WHERE e.id IS NULL ORDER BY o.created_at LIMIT ?`).all(limit) as LearningProjectionLedgerRow[];
  }
