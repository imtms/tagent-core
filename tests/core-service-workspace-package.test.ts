...
const expectedDependencies = {
  "@tagent/admission": "0.8.11",
  "@tagent/execution": "0.8.11",
  "@tagent/governance": "0.8.11",
  "@tagent/http-fastify": "0.8.11",
  "@tagent/memory": "0.8.11",
  "@tagent/persistence-sqlite": "0.8.11",
  "@tagent/runtime-pi": "0.8.11",
  "@tagent/workspace-local": "0.8.11",
  "fflate": "^0.8.2",
  "yaml": "^2.9.0",
};
...
describe("Core service application workspace package", () => {
  ...
  it("publishes the private process App and Host through five explicit compiled ABI entries", () => {
    ...
    expect(manifest).toMatchObject({ name: "@tagent/core-service", version: "0.8.11", private: true });
  ...
  it("keeps dynamic release materialization and the core-service deploy fixture complete", () => {
    ...
    expect(fixture).toContain('"@tagent/core-service": "0.8.11"');
