...
const expectedDependencies = {
  "@tagent/admission": "0.8.2",
  "@tagent/execution": "0.8.2",
  "@tagent/governance": "0.8.2",
  "@tagent/http-fastify": "0.8.2",
  "@tagent/learning": "0.8.2",
  "@tagent/memory": "0.8.2",
  "@tagent/persistence-sqlite": "0.8.2",
  "@tagent/runtime-pi": "0.8.2",
  "@tagent/workspace-local": "0.8.2",
  "fflate": "^0.8.2",
  "yaml": "^2.9.0",
};
...
describe("Core service application workspace package", () => {
  ...
  it("publishes the private process App through four explicit compiled ABI entries", () => {
    ...
    expect(manifest).toMatchObject({ name: "@tagent/core-service", version: "0.8.2", private: true });
  ...
  it("keeps the root server as the only documented CLI entrypoint", () => {
    ...
    expect(text).not.toMatch(/\b(?:Store|CoreLifecycle|createApp|acquireCoreInstanceLock|claimCoreWriterConnectionWithRetry)\b/);
  ...
  it("keeps dynamic release materialization and the core-service deploy fixture complete", () => {
    ...
    expect(fixture).toContain('"@tagent/core-service": "0.8.2"');
