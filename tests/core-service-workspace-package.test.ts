...
const expectedDependencies = {
  ...
  "@tagent/http-fastify": "0.2.1",
  "@tagent/learning": "0.2.1",
  "@tagent/memory": "0.2.1",
  "@tagent/persistence-sqlite": "0.2.1",
  "@tagent/runtime-pi": "0.2.1",
  "@tagent/workspace-local": "0.2.1",
};
...
describe("Core service application workspace package", () => {
  ...
  it("publishes the private process App through four explicit compiled ABI entries", () => {
    ...
    expect(manifest).toMatchObject({ name: "@tagent/core-service", version: "0.2.1", private: true });
  ...
  it("keeps dynamic release materialization and the core-service deploy fixture complete", () => {
    ...
    expect(fixture).toContain('"@tagent/core-service": "0.2.1"');
