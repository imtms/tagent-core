...
const expectedDependencies = {
  "@tagent/admission": "0.5.0",
  "@tagent/execution": "0.5.0",
  "@tagent/governance": "0.5.0",
  "@tagent/http-fastify": "0.5.0",
  "@tagent/learning": "0.5.0",
  "@tagent/memory": "0.5.0",
  "@tagent/persistence-sqlite": "0.5.0",
  "@tagent/runtime-pi": "0.5.0",
  "@tagent/workspace-local": "0.5.0",
};
...
describe("Core service application workspace package", () => {
  ...
  it("publishes the private process App through four explicit compiled ABI entries", () => {
    ...
    expect(manifest).toMatchObject({ name: "@tagent/core-service", version: "0.5.0", private: true });
  ...
  it("keeps dynamic release materialization and the core-service deploy fixture complete", () => {
    ...
    expect(fixture).toContain('"@tagent/core-service": "0.5.0"');
