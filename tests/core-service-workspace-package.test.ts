...
const expectedDependencies = {
  "@tagent/admission": "0.5.4",
  "@tagent/execution": "0.5.4",
  "@tagent/governance": "0.5.4",
  "@tagent/http-fastify": "0.5.4",
  "@tagent/learning": "0.5.4",
  "@tagent/memory": "0.5.4",
  "@tagent/persistence-sqlite": "0.5.4",
  "@tagent/runtime-pi": "0.5.4",
  "@tagent/workspace-local": "0.5.4",
};
...
describe("Core service application workspace package", () => {
  ...
  it("publishes the private process App through four explicit compiled ABI entries", () => {
    ...
    expect(manifest).toMatchObject({ name: "@tagent/core-service", version: "0.5.4", private: true });
  ...
  it("keeps dynamic release materialization and the core-service deploy fixture complete", () => {
    ...
    expect(fixture).toContain('"@tagent/core-service": "0.5.4"');
