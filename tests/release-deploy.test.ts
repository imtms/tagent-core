...
async function releaseDirectory(root: string, commit: string, corrupt: "native" | "manifest" | "syntax" | null = null) {
  ...
  await writeFile(path.join(directory, "node_modules", "@tagent", "core-service", "package.json"), JSON.stringify({ name: "@tagent/core-service", type: "module", dependencies: { "@tagent/admission": "0.8.5", "@tagent/execution": "0.8.5", "@tagent/governance": "0.8.5", "@tagent/http-fastify": "0.8.5", "@tagent/memory": "0.8.5", "@tagent/persistence-sqlite": "0.8.5", "@tagent/runtime-pi": "0.8.5", "@tagent/workspace-local": "0.8.5" } }));
  ...
  await writeFile(path.join(directory, "node_modules", "@tagent", "persistence-sqlite", "package.json"), JSON.stringify({ name: "@tagent/persistence-sqlite", type: "module", dependencies: { "@tagent/admission": "0.8.5", "@tagent/execution": "0.8.5", "@tagent/governance": "0.8.5", "@tagent/memory": "0.8.5" } }));
