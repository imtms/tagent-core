...
async function releaseDirectory(root: string, commit: string, corrupt: "native" | "manifest" | "syntax" | null = null) {
  ...
  await writeFile(path.join(directory, "node_modules", "@tagent", "admission", "package.json"), JSON.stringify({ name: "@tagent/admission", type: "module", dependencies: { "@tagent/execution": "0.5.2", "@tagent/governance": "0.5.2" } }));
  ...
  await writeFile(path.join(directory, "node_modules", "@tagent", "core-service", "package.json"), JSON.stringify({ name: "@tagent/core-service", type: "module", dependencies: { "@tagent/admission": "0.5.2", "@tagent/execution": "0.5.2", "@tagent/governance": "0.5.2", "@tagent/http-fastify": "0.5.2", "@tagent/learning": "0.5.2", "@tagent/memory": "0.5.2", "@tagent/persistence-sqlite": "0.5.2", "@tagent/runtime-pi": "0.5.2", "@tagent/workspace-local": "0.5.2" } }));
  ...
  await writeFile(path.join(directory, "node_modules", "@tagent", "http-fastify", "package.json"), JSON.stringify({ name: "@tagent/http-fastify", type: "module", dependencies: { "@tagent/abi": "0.5.2", "@tagent/admission": "0.5.2", "@tagent/execution": "0.5.2", "@tagent/governance": "0.5.2" } }));
  await writeFile(path.join(directory, "node_modules", "@tagent", "http-fastify", "dist", "index.js"), "export {};\n");
  await writeFile(path.join(directory, "node_modules", "@tagent", "execution", "package.json"), JSON.stringify({ name: "@tagent/execution", type: "module", dependencies: { "@tagent/governance": "0.5.2" } }));
  await writeFile(path.join(directory, "node_modules", "@tagent", "execution", "dist", "index.js"), "export {};\n");
  await writeFile(path.join(directory, "node_modules", "@tagent", "learning", "package.json"), JSON.stringify({ name: "@tagent/learning", type: "module", dependencies: { "@tagent/admission": "0.5.2", "@tagent/execution": "0.5.2", "@tagent/governance": "0.5.2", "@tagent/memory": "0.5.2" } }));
  ...
  await writeFile(path.join(directory, "node_modules", "@tagent", "persistence-sqlite", "package.json"), JSON.stringify({ name: "@tagent/persistence-sqlite", type: "module", dependencies: { "@tagent/admission": "0.5.2", "@tagent/execution": "0.5.2", "@tagent/governance": "0.5.2", "@tagent/learning": "0.5.2", "@tagent/memory": "0.5.2" } }));
  await writeFile(path.join(directory, "node_modules", "@tagent", "persistence-sqlite", "dist", "index.js"), "export {};\n");
  await writeFile(path.join(directory, "node_modules", "@tagent", "runtime-pi", "package.json"), JSON.stringify({ name: "@tagent/runtime-pi", type: "module", dependencies: { "@tagent/execution": "0.5.2" } }));
  await writeFile(path.join(directory, "node_modules", "@tagent", "runtime-pi", "dist", "index.js"), "export {};\n");
  await writeFile(path.join(directory, "node_modules", "@tagent", "workspace-local", "package.json"), JSON.stringify({ name: "@tagent/workspace-local", type: "module", dependencies: { "@tagent/execution": "0.5.2" } }));
  await writeFile(
