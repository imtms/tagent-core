...
describe("Execution workspace package", () => {
  it("publishes only the explicit compiled Execution ABI", () => {
    ...
    expect(execution).toMatchObject({ name: "@tagent/execution", version: "0.8.23", private: true });
    ...
    expect(execution.dependencies).toEqual({ "@tagent/governance": "0.8.23" });
  ...
  it("keeps the explicit implementations in the Execution package", () => {
    ...
    expect(implementationFiles).toEqual(expect.arrayContaining([
      ...
      "packages/execution/src/application/post-attempt-finalizer.ts",
      "packages/execution/src/application/project-context-projection.ts",
      ...
      "packages/execution/src/application/runtime-dynamic-context.ts",
      "packages/execution/src/application/runtime-skill.ts",
      "packages/execution/src/application/settlement-approval.ts",
      ...
      "packages/execution/src/application/user-input-submission.ts",
      ...
      "packages/execution/src/ports/subprocess-port.ts",
      "packages/execution/src/ports/tool-error.ts",
