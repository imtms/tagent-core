...
describe("v1 API contracts", () => {
  ...
  it("creates Sessions idempotently, exposes GET, and publishes capabilities", async () => {
    ...
    expect(capabilities).toMatchObject({ releaseVersion: "0.6.7", persistenceSchemaVersion: 46, interactions: { approvalResolution: true, userInputSubmission: true }, operator: { roadmapGenerationIdempotent: true } });
  });
