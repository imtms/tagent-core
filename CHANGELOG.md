...
- Corrected the Topic descriptor test fixture's mutability typing after the complete CI type gate rejected the unpublished `v0.8.21` candidate.

## [0.8.21] - 2026-08-22

### Release status

- Withheld after CI rejected a test-only readonly fixture before any GitHub Release or artifacts were published; superseded by `v0.8.22`.
